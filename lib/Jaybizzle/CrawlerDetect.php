...
class Jaybizzle_CrawlerDetect
{
    ...
    {
        $this->crawlers = new Jaybizzle_Fixtures_Crawlers();
        $this->exclusions = new Jaybizzle_Fixtures_Exclusions();
        $this->uaHttpHeaders = new Jaybizzle_Fixtures_Headers();
