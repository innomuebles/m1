...
class Webgility_Ecc_Model_ShiplarkWgBaseResponse
{
	...
	public function message()
	{
		...
		$str .= '<div>WEBGILITY ACCOUNT<br><br>To use this extension, you must have a Webgility Account. You can sign up for an account below or log in with your existing account.<br><a href=" http://www.shiplark.com/shipping-software-pricing.php" target="_blank">Sign Up</a><br>
				<a href="http://portal.webgility.com/login.php" target="_blank">Log In</a>.<br><br>';
