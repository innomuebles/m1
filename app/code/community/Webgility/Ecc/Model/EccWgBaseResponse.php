...
class Webgility_Ecc_Model_EccWgBaseResponse
{
	...
	public function message()
	{
		...
		$str .= '<div><b>WEBGILITY ACCOUNT</b><br><br>To use this extension, you must have a Webgility Account. You can sign up for an account below or log in with your existing account.<br><a href="http://www.webgility.com/ecc/pricing.php" target="_blank">Sign Up</a><br>
		...
		*/
		...
		$str .= '<div><br>Copyright &copy; 2013 Webgility Inc.</div>'; 
		return $str;			
