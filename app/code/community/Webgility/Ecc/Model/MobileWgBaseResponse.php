...
class Webgility_Ecc_Model_MobileWgBaseResponse
{
	...
	public function message()
	{
		...
		$str .= '<div><b>WEBGILITY ACCOUNT</b><br><br>To use this extension, you must have a Webgility Account. You can sign up for an account below or log in with your existing account.<br>
				<a href="http://portal.webgility.com/login.php" target="_blank">Log In</a>.<br><br>';
		$str .= '<b>STORE MODULE ADDRESS</b><br><br>';
