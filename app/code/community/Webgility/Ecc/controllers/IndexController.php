...
class Webgility_Ecc_IndexController extends Mage_Core_Controller_Front_Action {     
	...
	$cartCompitableVersion='Community Edition 1.2.1 to 1.9.1.0, Enterprise Edition 1.7.1 to 1.14.1.0';
...
<div id="wrap">eCC Store Module (v'.Webgility_Ecc_Helper_Data::STORE_MODULE_VERSION.')</div>
	...
	<div id="footer">
		<p>&copy; Copyright 2013 Webgility Inc all rights reserved.</p>
	</div>';
