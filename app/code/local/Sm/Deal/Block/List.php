				...
				if ($products != null) {
					...
					if (!empty($_products)) {
						foreach ($_products as $_product) {
							...
							$_product->_image = (string)Mage::helper('catalog/image')->init($_product, 'thumbnail')->resize($this->_getConfig('imgcfg_width'), $this->_getConfig('imgcfg_height'));
							$_product->_description = $helper->_cleanText($_product->getShortDescription());
