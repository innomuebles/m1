...
class TM_BotProtection_Block_Adminhtml_Blacklist_Edit_Form
    extends TM_BotProtection_Block_Adminhtml_Abstract_List_Edit_Form
{

    protected function _prepareForm()
    {
        $this->_prefix = 'blakclist_';
        ...
        // fieldset for additional section
        $this->_prepareFieldsetAdditional($form);

        $model = Mage::registry('tm_blacklist');
