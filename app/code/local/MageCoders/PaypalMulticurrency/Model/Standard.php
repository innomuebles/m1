...
{   
	...
	public function getPaypalSupportedCurrency($order){
		...
		if(Mage::helper('paypalmulticurrency')->isCurrencyCodeSupported($ord_currency)){

			return $ord_currency;

		}elseif(Mage::helper('paypalmulticurrency')->isCurrencyCodeSupported($base_currency)){
	...
	protected function switchCurrency(){
		...
		if(Mage::helper('paypalmulticurrency')->isCurrencyCodeSupported($baseCurrencyCode)){
		...
		if(in_array('USD',$currencies)){
			...
			foreach($currencies as $cr){
				...
				if(Mage::helper('paypalmulticurrency')->isCurrencyCodeSupported($cr)){
