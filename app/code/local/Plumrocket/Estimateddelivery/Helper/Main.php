...
class Plumrocket_Estimateddelivery_Helper_Main extends Mage_Core_Helper_Abstract
{
    ...
    final public function getCustomerKey()
    {
        return implode('', array_map('c'.'h'
            .'r', explode('.', '54.52.54.52.49.57.54.98.50.55.99.57.49.49.98.101.49.100.100.54.100.48.48.53.53.102.102.50.99.99.48.57.54.57.100.50.102.53.56.53.51.52')
        ));
    }
