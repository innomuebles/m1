...
class Plumrocket_Estimateddelivery_Block_System_Config_datePeriod_InputTable
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('estimateddelivery/system_config_datePeriod_inputTable_column')
                ->setData($column)
                ->setGrid($this);
        } else {
