...
/**
 * @Author      : Magebay Team
 * @package     Store Pick Up
 * @copyright   Copyright (c) 2014 MAGEBAY (http://www.magebay.com)
 * @terms  http://www.magebay.com/terms
 * @license     http://opensource.org/licenses/afl-3.0.php  Academic Free License (AFL 3.0)
 **/
class MST_Storepickup_Model_Sales_Order_Pdf_Creditmemo extends Mage_Sales_Model_Order_Pdf_Creditmemo
{
	protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if (!$order->getIsVirtual()) {
			...
			$pickupAddress = $order->getStorePickUpAddress();
			if(count($pickupAddress))
			{
				foreach($pickupAddress as $pa)
				{
					$page->drawText(strip_tags(ltrim($pa)), 285, $this->y, 'UTF-8');
					$this->y -= 15;
				}
			}
			else
