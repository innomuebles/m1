<?php
class MST_Storepickup_Block_Adminhtml_Storepickup_Grid_Gridmessages extends Mage_Adminhtml_Block_Widget_Container 
{
 function __construct()
 {
    parent::__construct();
    $this->setTemplate('storepickup/grid/messages.phtml');
 }
